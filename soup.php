...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div class="body-wrapper">
                                ...
                                <div class="collapse navbar-collapse" id="navbar">
                                    <div class="navbar-right">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a class="page-scroll" href="/#menu">Menus</a></li>
        ...
        <div class="page-hero-section menu-page">
            <div class="container">	
                <div class="hero text-center">

                    <!-- Title -->
                    <h2 class="hero-title">Soup</h2>
                        ...
                        <div class="breadcrumb-nav">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb-list">
                                    ...
                                    <li class="breadcrumb-item"><a href="menus.html">Menus</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Soup</li>
                                </ul>
                            </nav>
                        </div> 
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-1.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-1.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Chicken Noodle</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">Uncooked egg noodles, ribs, rotisserie chicken, carrots, olive oil</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$8.50</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-2.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-2.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Ultimate Bacon</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">House beef patty, cheddar cheese, bacon, onion, mustard</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$9.99</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-3.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-3.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Black Sheep</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">American cheese, tomato relish, avocado, lettuce, red onion</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$9.75</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-4.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-4.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Double Burger</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">2 beef patties, cheddar cheese, mustard, pickles, tomatoes</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$10.35</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-5.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-5.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Turkey Burger</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">Turkey, cheddar cheese, onion, lettuce, tomatoes, pickles</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$8.95</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-6.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-6.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Smokey House</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">Beef patty, cheddar cheese, onion, lettuce, tomatoes, pickles</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$9.50</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-7.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-7.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">Beef, cheddar cheese, ketchup, mustard, pickles, onion</p>
                                
                                <div class="menu-action">

                                    <!-- Price -->
                                    <h5 class="menu-price">$7.95</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-img">
                                ...
                                <!-- Image -->
                                <a href="src/assets/img/photos/menus/soup/img-8.jpg" class="d-block fancybox">
                                    <img class="img-fluid" src="src/assets/img/photos/menus/soup/img-8.jpg" alt="menu-image">
                                </a>
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Vegan Burger</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">Mushroom patty, vegan cheese, lettuce, tomatoes, avocado</p>
                        ...
                        <div class="menu-item bg-white">
                            ...
                            <div class="menu-txt">
                                ...
                                <div class="menu-header">
                                    ...
                                    <!-- Title -->
                                    <h5 class="menu-title">Crispy Chicken</h5>
                                ...
                                <!-- Description -->	
                                <p class="menu-desc">Chicken breast, chilli sauce, tomatoes, pickles, coleslaw</p>
