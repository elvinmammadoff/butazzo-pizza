...
//    $ip = '104.130.122.30';
    ...
    $mg = new Mailgun('036bcbf18d89fc6bec6237815877c1ca-e51d0a44-89eb75f0'); // For US servers
//    $domain = 'sandbox63a4e019e8bb4d7cb2666133ae923151.mailgun.org';

    // Now, compose and send your message.
    // $mg->messages()->send($domain, $params);
    $result = $mg->sendMessage('sandbox70e67361a1ec4a3daa70d81c37eae905.mailgun.org', [
        'from'    => 'metinzakirov@gmail.com',
