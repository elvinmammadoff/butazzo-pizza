    ...
    <div class="container section" id="pages">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="demo">
                    <a href="https://butazzo-pizza.herokuapp.com" class="demo-item">
                        <div class="demo-inner page-1"></div>
                    </a>
                    <h4 class="demo-title">Home Version 1</h4>
                    <a href="https://butazzo-pizza.herokuapp.com" class="button">View Page</a>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="demo">
                    <a href="https://butazzo-pizza.herokuapp.com/home-v2/" class="demo-item">
                        <div class="demo-inner page-2"></div>
                    </a>
                    <h4 class="demo-title">Home Version 2</h4>
                    <a href="https://butazzo-pizza.herokuapp.com/home-v2/" class="button">View Page</a>
                </div>
            </div>
        </div>
    </div>
