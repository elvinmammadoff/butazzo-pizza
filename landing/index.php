    ...
    <div class="container section" id="pages">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="demo">
                    <a href="https://themeforest.net/item/butazzo-pizza-one-page-html/21838834?s_rank=2" class="demo-item">
                        <div class="demo-inner page-1"></div>
                    </a>
                    <h4 class="demo-title">Home Version 1</h4>
                    <a href="https://themeforest.net/item/butazzo-pizza-one-page-html/21838834?s_rank=2" class="button">View Page</a>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="demo">
                    ...
                    <a href="" class="button">View Page</a>
                </div>
            </div>
        </div>
    </div>
