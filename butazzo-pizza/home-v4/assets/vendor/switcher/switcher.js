...
function addSwitcher()
{
	...
	var demoBox = '<div class="demo-sidebar"><div class="demo-btn-bx"><a class="demo-btn-right" href="/">Check Demo </a> </div></div>';
	
	if($("#bpSwitcher-right").length == 0) {
		jQuery('body').append(bpSwitcher);
...
function setThemeOptionOnPage()
{
	...
	jQuery.each(themeOptionArr, function(optionKey, optionValue) {
		...
		themeOptionArr[optionKey] = (optionData != '')?optionData:bpSettingsOptions[optionKey];
	});
	bpSettingsOptions = themeOptionArr;
	new bpSettings(bpSettingsOptions);
}
