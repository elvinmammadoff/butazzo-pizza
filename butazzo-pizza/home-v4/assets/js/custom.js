/**
	Template Name 	 : Butazzo Pizza
	Author			 : Alissio
	Version			 : 1.3
	Author Portfolio : https://themeforest.net/user/alissio/portfolio
...
var butazzo = function(){
	...
	var handleHomeSearch = function() {
		...
		quikSearch.on('click',function() {
			jQuery('.bp-quik-search').fadeIn(500);
			jQuery('.bp-quik-search').addClass('On');
		});
		
		quikSearchRemove.on('click',function() {
			jQuery('.bp-quik-search').fadeOut(500);
			jQuery('.bp-quik-search').removeClass('On');
		});	
	...
	var handleShowPass = function(){
		jQuery('.show-pass').on('click',function(){
			var inputType = jQuery(this).parent().find('.bp-password');
		...
		var modalBox = `<div class="modal fade inquiry-modal style-1" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="inquiry-adv">
					<img src="https://placehold.co/485x579" alt=""/>
				</div>
	...
	var handleParallaxScroll = function(){
		if(jQuery('.bp-parallax').length > 0){
			$(window).on("load scroll", function() {
				var parallaxElements = $(".bp-parallax");
	...
	var handleSupport = function(){
		var support = '<script id="BPScript" src="https://bpassets.s3.amazonaws.com/w3-global.js"></script>';
